"""
Constants for the Emergency Cards app, including predefined messages for different conditions
...
PREDEFINED_MESSAGES = {
    'CEL': {  # Celiac Disease
        'en': (
            ...
            "In case of emergency, please ensure all food and medication is gluten-free."
        ),
        'es': (
    ...
    'ALL': {  # Wheat/Gluten Allergy
        'en': (
            "I have a wheat/gluten allergy. Exposure can cause a severe allergic reaction that may require emergency medical attention. "
...
MEDICAL_INFO_BULLETS = {
    ...
    'ALL': {  # Wheat/Gluten Allergy
        'en': [
            ...
            "Emergency medication may be necessary"
        ],
        'es': [
